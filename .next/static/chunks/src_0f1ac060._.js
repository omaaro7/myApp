...
_s(AudioRecorder, "9vm8ZOfr6ET1WwNbtXDFd4klUlE=", false, function() {
    return [
...
"[project]/src/app/[lang]/dashboard/storage/storage-page-client.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoragePageClient.useEffect": ()=>{
            ...
            const unsubSubjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(subjectsQuery, {
                "StoragePageClient.useEffect.unsubSubjects": (snap)=>{
                    const subjectsList = snap.docs.map({
                        "StoragePageClient.useEffect.unsubSubjects.subjectsList": (d)=>d.data().name
                    }["StoragePageClient.useEffect.unsubSubjects.subjectsList"]);
                    setSubjects(subjectsList);
                // If there are subjects but nothing selected, keep empty to force explicit choice
                }
            }["StoragePageClient.useEffect.unsubSubjects"], {
                "StoragePageClient.useEffect.unsubSubjects": (error)=>console.error('Error loading subjects:', error)
            }["StoragePageClient.useEffect.unsubSubjects"]);
            ...
            const unsubFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(filesQuery, {
                "StoragePageClient.useEffect.unsubFiles": (snap)=>{
                    const filesList = snap.docs.map({
                        "StoragePageClient.useEffect.unsubFiles.filesList": (d)=>({
                                id: d.id,
                                ...d.data(),
                                createdAt: d.data().createdAt?.toDate() ?? new Date()
                            })
                    }["StoragePageClient.useEffect.unsubFiles.filesList"]);
                    setFiles(filesList);
                    setLoading(false);
                }
            }["StoragePageClient.useEffect.unsubFiles"], {
                "StoragePageClient.useEffect.unsubFiles": (error)=>console.error('Error loading files:', error)
            }["StoragePageClient.useEffect.unsubFiles"]);
            return ({
                "StoragePageClient.useEffect": ()=>{
                    unsubSubjects();
...
_c = StoragePageClient;
var _c;
__turbopack_context__.k.register(_c, "StoragePageClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_0f1ac060._.js.map