...
function QuestionsPage() {
    ...
    const filteredQuestions = questions.filter((q)=>subjectFilter === 'all' || q.subject === subjectFilter).filter((q)=>difficultyFilter === 'all' || q.difficulty === difficultyFilter).filter((q)=>q.question.toLowerCase().includes(searchTerm.toLowerCase()));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d65dfaa._.js.map